...
def airtime_18x_tar(root_dir, version):
    do_sudo('apt-get update')
    do_sudo('apt-get install -y --force-yes tar gzip unzip apache2 php5.6-pgsql libapache2-mod-php5.6 ' + \
        'php-pear php5.6-gd postgresql odbc-postgresql python python-configobj poc-streamer ' + \
        ...
        'libportaudio2 libsamplerate0 libcamomile-ocaml-dev ecasound php5.6-curl mpg123 ' + \
    ...
    sed('/etc/php/5.6/apache2/php.ini', ";upload_vdi_dir =", "upload_vdi_dir = /tmp", use_sudo=True)
    sed('/etc/php/5.6/apache2/php.ini', ";date.timezone =", 'date.timezone = "America/Toronto"', use_sudo=True)
